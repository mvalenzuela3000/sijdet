			...
			<div class="col-md-3 left_col">
	          <div class="left_col scroll-view">
	            <div class="navbar nav_title" style="border: 0;">
	              <a href="http://www.ait.gob.bo/jornadas" class="site_title"><span>Jornadas - AIT</span></a>
	            </div>
		            		...
		            		<div class="x_panel">
		            			<div class="x_title">
				              	...
				              	<div class="x_content" data-toggle="validator">
							        ...
							        <form class="form-horizontal form-label-left" enctype="multipart/form-data" id="myForm" role="form" data-toggle="validator" action="control/registra_preinscripcionm.php" method="post">
										...
										<span class="section">Datos del Depósito Bancario, de la Transferencia o de la Beca, por favor seleccione el modo de pago</span>
		                         		...
		                         		<div class="item form-group">
		                         			<div class="col-md-4 col-sm-6 col-xs-12">
		                          			...
		                          			<div class="col-md-4 col-sm-6 col-xs-12">
		                            			<h2><label> 
					                        		Cheque: <input type="radio"  name="tipodep" id="cheque" onchange="habilitaradio(this.value);" value="2" />
					                        	</label></h2>
		                          			</div>
		                          			<!--<div class="col-md-3 col-sm-6 col-xs-12">
		                            			<h2><label>
			                        	...
			                        	<div id="div1dep" style="display:;">
					                        ...
					                        <div class="form-group" >
					 							...
					 							<div class="col-md-3 col-sm-6 col-xs-12">
						                    		<input id="file-1" name="file-1" type="file" class="file" data-preview-file-type="any" data-allowed-file-extensions='["jpg","JPG", "jpeg","png","bmp","doc","docx","pdf"]'  accept="application/pdf,image/png, .jpeg, .jpg, .JPG, .bmp" >
					                        	</div>
				                  	 		</div>
			                        	...
			                        	<div id="divfact" style="display:;" >
			                        		...
			                        		<div class="item form-group">
			                         		...
			                         		<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input type="number" id="nitci" name="nitci" required="required" data-validate-minmax="10,200000000" class="form-control col-md-7 col-xs-12">
													<div class="help-block with-errors"></div>
												</div>
											</div>
										</div>
