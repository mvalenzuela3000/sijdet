...
<html lang="en">
  <head>
    ...
    <title>AIT | Registro de Oficinas</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="FormRegUser.php" class="site_title"> <span>Registro de Oficinas</span></a>
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro<small>oficinas</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="control/registra_oficina.php" method="post" name="registration_form">

                     
                      <span class="section">Informaci&oacute;n de las oficinas</span>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="abrev">Abreviatura <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="abrev" class="form-control col-md-7 col-xs-12" data-validate-length-range="8"  name="abrev" placeholder="ingrese la abreviatura" required="required" type="text">
                        </div>
                      </div>
               ...
               <!--tablas-->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Oficinas <small>Listado de oficinas</small>
									</h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
                    ...
                    $conex = mysqli_connect(HOST, USER, PASSWORD, DATABASEP);
                      $query = "CALL pa_obtiene_oficinas()";
                              ...
                              if ($result = mysqli_store_result($conex)) {
                                  while ($row = mysqli_fetch_row($result)) {
									...
									echo "<tr>
                                            ...
                                            <td>".$row[1]."</td>
                                            <td>".$row[2]."</td>
                                            <td><a class=\"btn btn-success btn-xs\" href=\"editOficina.php?1d='".base64_encode($row[0])."'\" onClick=\"window.open(this.href, this.target,'top=50,left=50,width=600,height=600,'); return false;\" > Editar</a>
                                            <a class=\"btn btn-danger btn-xs\" href=\"control/eliminaOficina.php?1d='".base64_encode($row[0])."'\" onclick=\"return confirmar();\"> Eliminar</a> 	
                                            </td>
