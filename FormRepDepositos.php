...
<html lang="en">
  <head>
    ...
    <title>AIT | Reportes inscripciones</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="FormRepDepositos.php" class="site_title"> <span>Reportes de Depósitos, Cheques y Transferencias</span></a>
            </div>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Reporte de Depósitos, Transferencias y Cheques</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Reportes<small>Depósitos, transferencias y cheques </small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="genera_reporte_depositos.php" method="post" name="registra_fechas">
                      ...
                      <div class="item form-group">
                      	<label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccione el tipo de filtro <span class="required">*</span>
                        </label>
                 			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label> 
	                        		Todos: <input type="radio"  name="deposito" id="todos" value="0" checked="" />
                  				</label>
                  			</div>
                  			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label> 
	                        		Utilizados: <input type="radio"  name="deposito" id="utilizados"  value="1" />
	                        	</label>
                  			</div>
                  			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label> 
	                        		Sin utilizar: <input type="radio"  name="deposito" id="sinutilizar"  value="2" />
	                        	</label>
                  			</div>
                  			
                 		</div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Exportar a Excel <span class="required">*</span></label>
