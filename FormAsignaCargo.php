...
<html lang="en">
  <head>
    ...
    <title>AIT | Asignación de Cargos</title>
               ...
               <!--tablas-->  
                <div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Cargos <small>Listado para asignación</small>
									</h2>
                    ...
                    $conex = mysqli_connect(HOST, USER, PASSWORD, DATABASEP);
                      $query = "CALL pa_obtiene_cargos_asignacion()";
                              ...
                              if ($result = mysqli_store_result($conex)) {
                                  while ($row = mysqli_fetch_row($result)) {
									...
									echo "<tr>
                                            ...
                                            <td>";
                                            if($row[6]==1){
                                                echo "<a class=\"btn btn-warning btn-xs\" href=\"control/accionPersona.php?0pt='".base64_encode('3')."'&1d='".base64_encode($row[7])."'\" onclick=\"return confirmar();\"> Desvincular</a>";     
                                            }else{
                                                echo "<a class=\"btn btn-success btn-xs\" href=\"asignaCargo.php?1d='".base64_encode($row[0])."'&c4='".base64_encode($row[4])."'\" onClick=\"window.open(this.href, this.target,'top=50,left=50,width=600,height=500,'); return false;\" > Asignar</a>";    
                                            }
                                            echo "</td>
