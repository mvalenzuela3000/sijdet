          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro<small>Becas</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="control/importarBecas.php" method="post" name="registra_becas"  enctype="multipart/form-data">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="excel" name="excel" type="file" class="file" multiple=true data-preview-file-type="any" data-allowed-file-extensions='["xls","xlsx"]'>
                        </div>
                      </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Becas registradas <small>Listado de becas cargadas</small>
									</h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
                    ...
                    $conex = conexj();
                      $query = "CALL pa_obtiene_becas_registradas()";
