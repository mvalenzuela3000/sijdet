        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="FormBusQueja.php" class="site_title"> <span>B&uacute;squeda de quejas</span></a> 
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-exclamation-triangle"></i> Quejas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="FormBusQueja.php">B&uacute;squeda de Quejas</a></li>
                      <li><a href="FormQuejasRegistradas.php">Quejas Registradas</a></li>
                    </ul>
                  </li>
