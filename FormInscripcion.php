			...
			<div class="col-md-3 left_col">
	          <div class="left_col scroll-view">
	            <div class="navbar nav_title" style="border: 0;">
	              <a href="FormInscripcion.php" class="site_title"><span>X JBDT - AIT</span></a>
	            </div>
        		...
        		<div class="">
		            ...
		            <div class="row">
		            	<div class="col-md-12 col-sm-12 col-xs-12">
		            		<div class="x_panel">
		            			<div class="x_title">
				                	<h2>Datos de Inscripción <small>Becados</small></h2>
				              	...
				              	<div class="x_content" data-toggle="validator">
				              		...
				              		<span class="section">Formulario para la inscripción de Becados a las <?php echo nombreevento(date("Y"));?>.</span>
							        <form class="form-horizontal form-label-left" enctype="multipart/form-data" id="myForm" role="form" data-toggle="validator" action="control/registra_becados.php" method="post">
