...
<html lang="en">
  <head>
    ...
    <title>AIT | Listados acreditaciones</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="FormListaAcredita.php" class="site_title"> <span>Reportes de Inscripciones</span></a>
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Listados<small>para Acreditaciones por gestión</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="lista_acreditacion.php" method="post" name="listado_acredita">
					  ...
					  <div class="item form-group">
                      	<label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccione el Rango <span class="required">*</span>
							...
							<div class="col-md-1 col-md-sm-6 col-xs-12">
								<label>
									A - C: <input type="radio"  name="inscrito" id="ac"  value="7" />
								</label>
							</div>
							
							<div class="col-md-1 col-md-sm-6 col-xs-12">
								<label>
									D - L: <input type="radio"  name="inscrito" id="dl"  value="8" />
								</label>
							</div>
							
							<div class="col-md-1 col-md-sm-6 col-xs-12">
								<label>
									M - R: <input type="radio"  name="inscrito" id="mr"  value="9" />
								</label>
							</div>
							
							<div class="col-md-1 col-md-sm-6 col-xs-12">
								<label>
									S - Z: <input type="radio"  name="inscrito" id="sz"  value="10" />
								</label>
							</div>
