...
verifica_jornada_inscripcion($ci,$gestion);
verifica_cupos_reg($gestion,1,$ci);
		            		...
		            		<div class="x_panel">
		            			<div class="x_title">
				              	...
				              	<div class="x_content" data-toggle="validator">
							        ...
							        <form class="form-horizontal form-label-left" enctype="multipart/form-data" id="myForm" role="form" data-toggle="validator" action="control/inscribePreinscrito.php" method="post">
			                        	...
			                        	<div id="divfact" style="display:;" >
			                        		...
			                        		<div class="item form-group">
			                         		...
			                         		<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input type="number" id="nitci" name="nitci" required="required" data-validate-minmax="10,200000000" class="form-control col-md-7 col-xs-12" value="<?php echo $valores[16];?>">
													<div class="help-block with-errors"></div>
												</div>
											</div>
										</div>
