		            		...
		            		<div class="x_panel">
		            			<div class="x_title">
				              	...
				              	<div class="x_content" data-toggle="validator">
							        ...
							        <form class="form-horizontal form-label-left" enctype="multipart/form-data" id="myForm" role="form" data-toggle="validator" action="control/registra_preinscripcion_habilitados.php" method="post">
			            	    		<script>
