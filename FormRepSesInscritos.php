...
<html lang="en">
  <head>
    ...
    <title>AIT | Listados X Sesiones Paralelas</title>
	...
	<script src="js/ajaxsesionxgestion.js"></script>
  </head>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="FormListaAcredita.php" class="site_title"> <span>Listados X Sesiones</span></a>
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Listados<small>de inscritos por sesión elegida</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="lista_inscritosxsesion.php" method="post" name="listado_xsesion">

					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccione la Gestión <span class="required">*</span>
                        </label>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                        	<select id="gestion" name="gestion" class="form-control" required="required" onchange="load(this.value)">
                      ...
                      <div class="item form-group" id="myDiv"></div>
