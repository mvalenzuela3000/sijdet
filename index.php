      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
          	<img src="images/ait-trans.png" /><br />
            <form action="includes/process_login.php" method="post" name="login_form">
            	
              <h1>Formulario de inicio</h1>
              <div>
                <input type="text" class="form-control" placeholder="Usuario" name="id_user" required="" autofocus/>
              </div>
              <div>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
          	<img src="images/ait-trans.png" /><br />
            <form  action="includes/update.inc.php" method="post" name="update_form" novalidate >
            	
              <h1>Reestablecer password</h1>
              <div class="item form-group">
                <input type="text" class="form-control" placeholder="Usuario" name="id_userp" data-validate-length-range="2" required="" />
              </div>
              <div class="item form-group">
