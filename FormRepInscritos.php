        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="FormRepInscritos.php" class="site_title"> <span>Reportes de Inscripciones</span></a>
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Reportes<small>Inscripciones por gestión y por tipo de inscrito</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="genera_reporte_inscritos.php" method="post" name="registra_fechas">
                      ...
                      <div class="item form-group">
                      	<label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccione el tipo de inscrito <span class="required">*</span>
                        </label>
                 			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label> 
	                        		Todos: <input type="radio"  name="inscrito" id="todos" value="0" checked="" />
                  				</label>
                  			</div>
                  			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label> 
	                        		Inscritos: <input type="radio"  name="inscrito" id="pago"  value="1" />
	                        	</label>
                  			</div>
                  			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label> 
	                        		Becados: <input type="radio"  name="inscrito" id="beca"  value="2" />
	                        	</label>
                  			</div>
                  			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label> 
	                        		Func. AIT: <input type="radio"  name="inscrito" id="funcait"  value="3" />
	                        	</label>
                  			</div>
                  			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label>
	                        		Expositores: <input type="radio"  name="inscrito" id="expo"  value="4" />
	                        	</label>
                  			</div>
                  			<div class="col-md-1 col-sm-6 col-xs-12">
                    			<label>
	                        		Cta. x Cobrar: <input type="radio"  name="inscrito" id="cxc"  value="5" />
	                        	</label>
                  			</div>
                 		</div>
