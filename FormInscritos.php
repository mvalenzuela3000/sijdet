...
<title>AIT | Listado de Inscritos</title>
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="FormInscritos.php" class="site_title"> <span>Inscritos </span></a>
					</div>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>
								Inscritos <small>Lista de inscritos</small>
							</h3>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Inscritos <small>Listado de inscritos registrados (entre pagos, becados y expositores)</small>
									</h2>
