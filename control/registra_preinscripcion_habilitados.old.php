<?php
	...
	function verifica_cupos($prof,$deposito,$conexionj)
	{
		$valor=0;
		$query="select fn_verifica_cupos_restantes_habilitados($prof,$deposito)";
		/*if($prof==3){
	...
	verifica_cupos($_POST["prof"],$_POST["numdepo"],$conexionj);
