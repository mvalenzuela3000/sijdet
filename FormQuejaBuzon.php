				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>
								Panel de quejas <small>Aqu&iacute; usted podr&aacute; visualizar
									las quejas registradas.</small>
							</h3>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Queja registrada <small>Queja registrada en la
                      ...
                      $query = "CALL pa_obtiene_quejas_id($id,$ges)";
