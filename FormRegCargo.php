...
<html lang="en">
  <head>
    ...
    <title>AIT | Registro de Cargos</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="FormRegUser.php" class="site_title"> <span>Registro de Cargos</span></a>
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro<small>cargos</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="control/registra_cargo.php" method="post" name="registration_form">

                     
                      <span class="section">Informaci&oacute;n de los cargos</span>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Oficina <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <select id="oficina" name="oficina" class="form-control" onchange="load(this.value)" required>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="item" class="form-control col-md-7 col-xs-12"  name="item" required="required" type="number" min="0" max="200">
                        </div>
                      </div>
                      <div class="item form-group">
               ...
               <!--tablas-->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Cargos <small>Listado de cargos</small>
									</h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
                    ...
                    $conex = mysqli_connect(HOST, USER, PASSWORD, DATABASEP);
                      $query = "CALL pa_obtiene_cargos(0,0,0)";
                          ...
                          do {
                              ...
                              if ($result = mysqli_store_result($conex)) {
                                  while ($row = mysqli_fetch_row($result)) {
                                    ...
                                    <td>".$row[4]."</td>
                                    <td>".$row[3]."</td>
                                    <td><a class=\"btn btn-success btn-xs\" href=\"editCargo.php?1d='".base64_encode($row[0])."'\" onClick=\"window.open(this.href, this.target,'top=50,left=50,width=600,height=650,'); return false;\" > Editar</a>";
                                    if($row[8]==1)
                                    {
                                      echo"<a class=\"btn btn-warning btn-xs\" href=\"control/accionCargo.php?0pt='".base64_encode('0')."'&1d='".base64_encode($row[0])."'\" > Desactivar</a>";
                                    }
                                    else {
                                      echo"<a class=\"btn btn-warning btn-xs\" href=\"control/accionCargo.php?0pt='".base64_encode('1')."'&1d='".base64_encode($row[0])."'\" > Activar</a>";
                                    }
                                            echo"<a class=\"btn btn-danger btn-xs\" href=\"control/eliminaCargo.php?1d='".base64_encode($row[0])."'\" onclick=\"return confirmar();\"> Eliminar</a> 	
                                            </td>
