<?php
 include 'includes/funj.php';
	...
	$inst=obtiene_inst_cxc($id);
	$cupos=verifica_cupos_cxc($inst);
	if($cupos==0){
		?>
        ...
        location.href = "https://www.ait.gob.bo";
    	</script>
	 <?php 
	 exit;
	}
	$nominst=utf8_decode(obtiene_nom_inst($inst));
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="col-md-3 left_col">
	          <div class="left_col scroll-view">
	            <div class="navbar nav_title" style="border: 0;">
	              <a href="https://www.ait.gob.bo/jornadas" class="site_title"><span>X JBDT - AIT</span></a>
	            </div>
		            		...
		            		<div class="x_panel">
		            			<div class="x_title">
				              	...
				              	<div class="x_content" data-toggle="validator">
							        ...
							        <form class="form-horizontal form-label-left" enctype="multipart/form-data" id="myForm" role="form" data-toggle="validator" action="control/registra_inscripcion_cxc.php" method="post">
			            	    		<script>
										...
										<div class="form-group">
					                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cupocuenta">Cupos disponibles para Becas<span class="required">*</span>
					                        </label>
					                        <div class="col-md-3 col-sm-6 col-xs-12">
					                          <input type="number" id="cupocuenta" name="cupocuenta" readonly="" class="form-control col-md-7 col-xs-12" value="<?php echo $cupos;?>" >
					                        </div>
				                        </div>
				                        <div class="item form-group">
			                       			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nominst">Institución <span class="required">*</span>
			                        		</label>
			                        		<div class="col-md-6 col-sm-6 col-xs-12">
			                          			<input id="nominst" class="form-control col-md-7 col-xs-12"  name="nominst" readonly="" type="text" value="<?php echo $nominst;?>">
			                        		</div>
			                      		</div>
			            	    		<div class="item form-group">
			                      		...
			                      		<div class="item form-group">
			                        		...
			                        		<div class="col-md-2 col-sm-6 col-xs-12">
			                          			<input type="number" id="number" name="number" required="required" data-validate-minmax="10,20000000" class="form-control col-md-7 col-xs-12">
			                          			<div class="help-block with-errors"></div>
			                        		</div>
					                    ...
					                    <p class="indent">
					                        a) La asistencia a las ponencias es obligatorira para recibir el Certificado de Participación. <br>
					                        b) Declaro que he revisado todos los datos insertados en el formulario, mismos que serán utilizados para la emisión del Certificado de Participación así como medio de contacto para la difución de noticias.
