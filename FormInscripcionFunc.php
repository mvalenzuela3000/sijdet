        		...
        		<div class="">
		            ...
		            <div class="row">
		            	<div class="col-md-12 col-sm-12 col-xs-12">
		            		<div class="x_panel">
		            			<div class="x_title">
				                	<h2>Datos de Inscripción <small>Funcionarios AIT</small></h2>
				              	...
				              	<div class="x_content" data-toggle="validator">
				              		...
				              		<span class="section">Formulario para la inscripción de Funcionarios de la AIT a las <?php echo nombreevento(date("Y"));?></span>
							        <form class="form-horizontal form-label-left" enctype="multipart/form-data" id="myForm" role="form" data-toggle="validator" action="control/registra_funcait.php" method="post">
			            	    		<div class="item form-group">
			                      		...
			                      		<div class="item form-group">
			                       		...
			                       		<div class="item form-group">
			                        		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="dpto">Dependencia <span class="required">*</span>
			                        		</label>
			                        		<div class="col-md-4 col-sm-6 col-xs-12">
			                          			<select id="depen" name="depen" class="form-control" required="required">
			                            			<option value="AGIT">AUTORIDAD GENERAL DE IMPUGNACION TRIBUTARIA</option>
			                            			<option value="ARITLPZ">AUTORIDAD REGIONAL DE IMPUGNACION TRIBUTARIA LA PAZ</option>
								                      <option value="ARITSCZ">AUTORIDAD REGIONAL DE IMPUGNACION TRIBUTARIA SANTA CRUZ</option>
								                      <option value="ARITCBA">AUTORIDAD REGIONAL DE IMPUGNACION TRIBUTARIA COCHABAMBA</option>
								                      <option value="ARITCHQ">AUTORIDAD REGIONAL DE IMPUGNACION TRIBUTARIA CHUQUISACA</option>
			                          			</select>
			                        		</div>
			                      		</div>
