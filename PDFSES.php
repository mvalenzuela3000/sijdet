...
class PDF extends FPDF
{
    function cabeceraHorizontal()
    {
        ...
        $ejeX = 30;
		$this->RoundedRect($ejeX, 40, 10, 7, 2, 'FD');
		$this->CellFitSpace(10,8, 'Nro',0, 0 , 'C');
		$ejeX = $ejeX + 10;
		$this->RoundedRect($ejeX, 40, 150, 7, 2, 'FD');
		$this->CellFitSpace(150,7, 'NOMBRES Y APELLIDOS',0, 0 , 'C');
		$ejeX = $ejeX + 150;
    ...
    function datosHorizontal($datos,$inicio,$fin)
    {
        ...
        for($j=$inicio;$j<$fin;$j++)
		{
            ...
            $this->RoundedRect(30, $ejeY, 160, 10, 2, 'D');
			$this->SetXY(30,$ejeY);
            $this->CellFitSpace(10,10, $cont,'R', 0 , 'C' );
            $this->CellFitSpace(150,10, $t,0, 0 , 'L' );
...
//**********************************************************************************************
 ...
 function RoundedRect($x, $y, $w, $h, $r, $style = '', $angle = '1234')
 ...
 
	{
	    ...
	    $this->CellFitSpace(120,20,'LISTADO INSCRITOS POR SESIONES',0,0,'C');
		$this->Ln(5);
